...
<c:set var="title" value="Manage Drivers" scope="page"/> 
<html> 
    <head> 
        ...
        <f:view>
            ...
            <h:form>
                <h:commandButton id="new" value="Create a new manager" 
                                 action="#{ListDriversManagedBean.CreateManager}"/>
                
                <h:dataTable id="managerList" value="#{ListDriversManagedBean.allManagers}" var="rowItem">
                    <h:column>
                        <f:facet name="header">
                    ...
                    <h:column>
                        ...
                        <h:commandLink action="#{ListDriversManagedBean.editSelectedManager}" value="Edit"  ></h:commandLink>
                    </h:column>
                </h:dataTable>
            </h:form>
        </f:view>
