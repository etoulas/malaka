...
loesche_jaeinzelflag:-
	/* Liste mit KO Antworten zuruecksetzen */
	retract(jaeinzelflag(1)),fail.
loesche_jaeinzelflag.

set_jaeinzelflag :-
	assert(jaeinzelflag(1)),
	!.
...
loesche_japartnerflag:-
	/* Liste mit KO Antworten zuruecksetzen */
	retract(japartnerflag(1)),fail.
loesche_japartnerflag.

set_japartnerflag :-
	assert(japartnerflag(1)),
	!.
