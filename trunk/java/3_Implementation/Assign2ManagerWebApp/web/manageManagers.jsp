        ...
        <f:view>
            ...
            <h:form>
                <h:commandButton id="new" value="Create a new manager" 
                                 action="#{ListManagersManagedBean.CreateManager}"/>
                
                <h:dataTable id="managerList" value="#{ListManagersManagedBean.allManagers}" var="rowItem">
                    <h:column>
                        <f:facet name="header">
                    ...
                    <h:column>
                        ...
                        <h:commandLink action="#{ListManagersManagedBean.editSelectedManager}" value="Edit"  ></h:commandLink>
                    </h:column>
                </h:dataTable>
            </h:form>
        </f:view>
