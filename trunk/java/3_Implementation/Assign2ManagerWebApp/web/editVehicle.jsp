...
<jsp:useBean class="assign2.webapp.mbean.editVehicle" scope="request" id="vehicleEdit" />
    ...
    <body>
        <f:view>
            ...
            <h:form>
                ...
                <h:commandLink action="#{createVehicle.addVehicle}" value="Save"/> - <h:commandLink action="#{createVehicle.addVehicle}" value="Delete"/>
                <br>
            </h:form>
        </f:view>
    </body>
