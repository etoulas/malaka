            ...
            <h:form id="enterDriverDetails">
                <h:panelGrid columns="2">
                    ...
                    <h:panelGroup>
                        ...
                        <h:selectOneMenu id="type" value="#{CreateUserManagedBean.selectedLicenseType}">
                            <f:selectItems value="#{CreateUserManagedBean.licenseTypes}"/>
                        </h:selectOneMenu>
                    </h:panelGroup>
                    <h:outputText value=""/>
                    ...
                    <h:commandButton id="submit" value="Continue" 
                                     action="#{CreateUserManagedBean.CreateDriver}"/>
