...
<c:set var="title" value="Edit Customer" scope="page"/> 
<html> 
    <head> 
                ...
                <h:panelGrid columns="2">
                    <h:panelGroup>
                        ...
                        <h:outputText id="username" 
                                      value="#{EditCustomerManagedBean.username}" 
                        />
                    </h:panelGroup>
                    <h:outputText value=""/>
                    ...
                    <h:panelGroup>
                        ...
                        <h:inputText id="firstName" 
                                     value="#{EditCustomerManagedBean.firstName}" 
                                     required="true" />
                    </h:panelGroup>     
                    <h:panelGroup>    
                        <h:outputLabel for="lastName" value="Last Name: "/>
                        <h:inputText id="lastName" 
                                     value="#{EditCustomerManagedBean.lastName}" 
                                     required="true" />
                    </h:panelGroup>
                    ...
                    <h:panelGrid columns="2">
                        ...
                        <h:inputText id="street" 
                                     value="#{EditCustomerManagedBean.street}" 
                                     required="true" />
                        <h:outputLabel for="streetNumber" value="Number: "/>                
                        <h:inputText id="streetNumber" 
                                     value="#{EditCustomerManagedBean.streetNumber}" 
                                     required="true" />
                        <h:outputLabel for="postCode" value="Postcode: "/>
                        <h:inputText id="postCode" 
                                     value="#{EditCustomerManagedBean.postCode}" 
                                     required="true" />
                        <h:outputLabel for="suburb" value="Suburb: "/>
                        <h:inputText id="suburb" 
                                     value="#{EditCustomerManagedBean.suburb}" 
                                     required="true" />
                        <h:outputLabel for="city" value="City: "/>
                        <h:inputText id="city" 
                                     value="#{EditCustomerManagedBean.city}" 
                                     required="true" />
                        <h:outputLabel for="state" value="State: "/>
                        <h:inputText id="state" 
                                     value="#{EditCustomerManagedBean.countryState}" 
                                     required="true" />
                        <h:outputLabel for="country" value="Country: "/>
                        <h:inputText id="country" 
                                     value="#{EditCustomerManagedBean.country}" 
                                     required="true" />
                        <h:outputLabel for="phone" value="Phone Number: "/>
                        <h:inputText id="phone" 
                                     value="#{EditCustomerManagedBean.phoneNumber}" 
                                     required="true" />
                    </h:panelGrid>
                    
                    <h:commandButton id="submit" value="Save" 
                                     action="#{EditCustomerManagedBean.EditManager}"/>
                    <h:commandButton id="cancel" value="Cancel" 
                                     action="#{EditCustomerManagedBean.CancelEditManager}"/>
                    <h:commandButton id="delete" value="Delete Manager" 
                                     action="#{EditCustomerManagedBean.DeleteManager}"/>
                    <h:commandButton id="chPassword" value="Change Password" 
                                     action="#{EditCustomerManagedBean.ChangePassword}"/>
